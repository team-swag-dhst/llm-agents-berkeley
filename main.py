...
from swag.tools import SearchInternet, ReadWebsite, search, read
            ...
            for c in content:
                ...
                if type(c) is ToolUseBlock:
                    ...
                    if c.name == "SearchInternet":
                        tool_result = search(SearchInternet(**c.input)) # type: ignore
                    elif c.name == "ReadWebsite":
                        tool_result = read(ReadWebsite(**c.input)) # type: ignore
                    else:
